(() => {
  ...
  const RELEASE_NOTES = Object.freeze({
    ...
    subtitle: 'Les demandes d’accès et les formulaires sont plus clairs sur téléphone.',
    items: [
      'Les boutons importants sont désormais plus visibles et plus faciles à toucher.',
      'Les champs obligatoires sont clairement indiqués dans les formulaires concernés.',
      'Les statuts et les listes de l’administration sont plus simples à parcourir.',
      'La lisibilité a été renforcée en modes clair et sombre.'
    ]
  });
