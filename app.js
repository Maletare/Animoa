(() => {
  ...
  const RELEASE_NOTES = Object.freeze({
    ...
    subtitle: 'L’affichage mobile est plus propre et plus fiable sur les petits écrans.',
    items: [
      'Les menus à trois points utilisent désormais une icône stable et parfaitement centrée.',
      'Les cartes de santé, de poids et de dépenses restent lisibles sur les téléphones étroits.',
      'Les onglets Santé et les noms longs ne débordent plus de leur emplacement.'
    ]
  });
