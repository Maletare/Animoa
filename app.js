(() => {
  ...
  const RELEASE_NOTES = Object.freeze({
    ...
    subtitle: 'La demande d’avis ne peut plus bloquer l’accès à l’application.',
    items: [
      'Après « Envoyer mon avis », la fenêtre reste fermée et l’avis déjà envoyé est reconnu immédiatement.',
      'Après « Plus tard » ou « Ne plus afficher », l’utilisateur retrouve aussitôt l’application, même si le réseau répond mal.',
      'Une protection locale empêche toute réouverture en boucle pendant la resynchronisation avec Supabase.'
    ]
  });
